# Leetcode Patterns
Many of the problems that are solved in here follow the [Grokking the Coding Interview: Patterns for Coding Questions course](https://www.educative.io/courses/grokking-the-coding-interview) on educative. Other problems are form Sean
